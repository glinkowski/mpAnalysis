...
#	Version 2, Step 2(d)
#	LASSO (Positive coeffs only) + Voting
#
...
# LASSO params
lAlphas = ([0.001, 0.0009, 0.0008, 0.0007, 0.0006, 0.0005,
	0.0004, 0.0003,	0.0002, 0.0001, 0.00009, 0.00008])
lMaxIter = 100000
lNorm = True
lPos = True
lFitIcpt = True
...
#		positive=lPos, fit_intercept=lFitIcpt)
	...
	print("Positive Coeffs score: {}".format(cfScore))
...
#			print("    completed {} of {}".format(thisRound, (numVotes - 1) ))
	...
	# write the file
	fname = 'ranked_paths-Lasso_VotingPos_{}.txt'.format(numVotes)
...
#	mp.writeRankedGenes02(si, 'Lasso_VotingPos_{}'.format(numVotes), cfPredLabel,
...
#	cfGenes['rank'] = gRankSums
	...
	# write the file
	fname = 'ranked_genes-Lasso_VotingPos_{}.txt'.format(numVotes)
	if newVerbose :
	...
	fname = 'parameters-Lasso_VotingPos_{}.txt'.format(numVotes)
	if newVerbose :
